...
bool WeyVehicleFactory::Init(const CanbusConf *canbus_conf) {
  // Init can client
  ...
  chassis_detail_writer_ =
      node_->CreateWriter<::apollo::canbus::Wey>(FLAGS_chassis_detail_topic);

  return true;
}

bool WeyVehicleFactory::Start() {
...
void WeyVehicleFactory::UpdateCommand(
...
void WeyVehicleFactory::PublishChassisDetail() {
  Wey chassis_detail;
...
WeyVehicleFactory::CreateMessageManager() {
  return std::unique_ptr<MessageManager<::apollo::canbus::Wey>>(
